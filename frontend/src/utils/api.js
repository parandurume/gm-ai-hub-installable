...
export const API = {
  ...
  meetingSttModelPath:`${BASE}/meeting/stt-model-path`,
  ...
  taskOrderGenerate:  `${BASE}/task-order/generate`,
  taskOrderSave:      `${BASE}/task-order/save`,
  taskOrderValidate:  `${BASE}/task-order/validate`,
  diff:               `${BASE}/diff`,
